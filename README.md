...
## Description
This is a Python toolkit that helps decision makers assess the areas most affected by the Urban Heat Island (UHI) effect in San Salvador, El Salvador. The toolkit includes visualization of the areas most affected by heat and time series analysis from 2025 using land surface temperature (LST) and the city of San Salvador classified by Local Climatic Zones (LCZ).
