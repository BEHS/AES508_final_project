...
## Description
Developed for AES508 spring 2026 semester at the University of Alabama in Huntsville, this is a Python toolkit that helps decision makers from San Salvador, El Salvador to assess the areas most affected by the Urban Heat Island (UHI) effect. The toolkit includes visualization of the areas most affected by heat, statistical analysis, and time series analysis from 2025 using land surface temperature (LST) and Local Climatic Zones (LCZs).
